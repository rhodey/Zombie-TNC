...
public class AX25Port implements KSSDataListener {
  ...
  private List<AX25FrameListener> ax25FrameListeners;
  private List<AX25Operator> ax25Operators;
  ...
  private List<Byte> receivedInfoField = new LinkedList<Byte>();
  ...
  public AX25Port(KISSPort kissPort) {
    ...
    ax25FrameListeners = new LinkedList<AX25FrameListener>();
    ax25Operators = new LinkedList<AX25Operator>();
  }
  ...
  private void frameComplete() {
    ...
    AX25Frame receivedFrame = new AX25Frame(received_source_address,
                                              AX25Protocol.unpackSSID(received_source_ssid),
                                              received_destination_address,
                                              AX25Protocol.unpackSSID(received_destination_ssid));
